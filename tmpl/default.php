...
<?php if ($displaycustomtab || $displaycreattab || $displaymanagetab || $displayadmintab || $displayfreetab) : ?>
	...
	<?php endif; ?>
		...
		<div class="tab-content">
              ...
              <a href="index.php?option=com_content&view=articles&filter[category_id]=<?php echo $cat_button->catidlist; ?>&filter[language]=<?php echo $cat_button->button_lang; ?>" target="<?php echo $cat_button->targetlink; ?>" >
                    <button type="button" class="btn btn-default btn-lg itemlist">
